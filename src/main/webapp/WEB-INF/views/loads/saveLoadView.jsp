...
<body>
    ...
    <form method="post" action="/saveLoad" modelAttribute = "editableLoad">
        ...
        <c:if test="${editableLoad.status != 'DONE'}">
            <tr>
                <th align="left">Vehicles registration numbers</th>
                <td>
                    <select class="select" id="vehicles" name="regNum" style="width:100%">
                        <option value="" selected disabled hidden>${editableLoad.vehicle.registrationNumber}</option>
